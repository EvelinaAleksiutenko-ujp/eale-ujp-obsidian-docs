...
2. **CTV** – Clinical Target Volume, Maybe add 'We are working on OAR's now)
3. "rigid or deformable registration or synthetic CT can be used instead" I am not getting how it is connected and what does it mean. Add more explanation.
4. Why  "Potential dose escalation"? 
5. 'LINAC with CBCT' imaging what does it means
6. Maybe add that the part of dosage calculation is deterministic.

Questions to Denis:
Confirm please:
In the step 3 we are assuming that CBCT or MRI are:
